function plotcylinder(axisi, VORT)
...
colormap(jet);
set(gca, ...
    'XTick',[1 50 100 150 200 250 300 350 400 449], ...
    'XTickLabel',{'-1','0','1','2','3','4','5','6','7','8'})
set(gca, ...
    'YTick',[1 50 100 150 199], ...
...
[c1,h1] = contour(axisi, V2,cvals*vortmax/5,'--k','LineWidth',1.);
contour(axisi, V2,-cvals*vortmax/5,'-k','LineWidth',1.)
